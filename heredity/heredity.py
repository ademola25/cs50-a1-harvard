...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # Determine trait status for this person
        ...
        if people[person]["mother"] is None and people[person]["father"] is None:
            ...
            # Has parents - calculate conditional probability
            mother = people[person]["mother"]
            father = people[person]["father"]
            
            # Determine number of genes for parents
            ...
            # Calculate probability of getting gene from mother
            if mother_genes == 2:
                prob_from_mother = 1 - PROBS["mutation"]  # Pass gene, might mutate away
            elif mother_genes == 1:
                prob_from_mother = 0.5 * (1 - PROBS["mutation"]) + 0.5 * PROBS["mutation"]
                # 0.5 chance of passing gene (then 1-mutation chance it stays)
                # + 0.5 chance of not passing gene (then mutation chance it becomes gene)
            else:  # mother_genes == 0
                prob_from_mother = PROBS["mutation"]  # Don't pass gene, might mutate to gene
            
            # Calculate probability of getting gene from father
            if father_genes == 2:
            ...
            # Calculate probability of having exactly 'genes' copies
            if genes == 2:
        ...
        # Multiply by this person's probability
