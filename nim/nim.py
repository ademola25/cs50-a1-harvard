...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        """
        # Convert state to tuple if it's a list
        state_tuple = tuple(state) if isinstance(state, list) else state
        
        # Return the Q-value for the (state, action) pair, or 0 if not found
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        # Calculate new value estimate (current reward + future rewards)
        ...
        self.q[(state_tuple, action)] = new_q_value
    ...
    def best_future_reward(self, state):
        ...
        # If no Q-values were found (all were 0), return 0
    ...
    def choose_action(self, state, epsilon=True):
        ...
        # If no actions are available, return None (shouldn't happen in practice)
        if not available_actions:
            return None
        ...
        # Otherwise, choose the best action (greedy)
        best_actions = []
        ...
        # Return one of the best actions (random choice if there are ties)
